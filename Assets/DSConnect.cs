...
public class DSConnect : MonoBehaviour

{
    // API配置
    [Header("API Settings")]
    [SerializeField] private string apiKey = "sk-f572fb23f9c34edfb6a439ad49610e86";// DeepSeek API密钥
    ...
    public class NPCCharacter
    {
        public string name;
        [TextArea(3, 10)] 
        public string personalityPrompt = "你是一个机器人，你只能输出{【前进/后退+XXX】（XXX为从000-999的三位数字，代表运动距离，例如001代表1米，005代表5米）输出标准格式案例：前进005}；{【右转/左转+XX度】，输出格式案例：右转45度}。现在你要分析案例做出合理的输出。";// 角色设定提示词
    }
